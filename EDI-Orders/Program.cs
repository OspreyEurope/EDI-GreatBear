        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length >= 1)
            {
                ...
                switch (choice)
                {
                    ...
                    case "WriteOrder":
                        EDIWrite.WriteOrder(conKTN, args[1]);
                        break;
                    case "WriteProductList":
                        EDIWrite.WriteProductList(conLive, "100994002");
                        break;
                    case "PO":
                        EDIWrite.WriteASNFile(conDev, args[1]);
                        break;
                    case "TruckDels":
                        EDIWrite.WriteTruckDelsFile(conDev, args[1]);
                        break;
                    #endregion
                    #region KTN Read
                    case "STKMVT":
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    switch (choice)
                    {
                        ...
                        #region Testing Wite File
                        case "WriteOrder":
                            EDIWrite.WriteOrder(conKTN, "0000398063");
                            EDIWrite.WriteOrder(conKTN, "0000460130");
                            EDIWrite.WriteOrder(conKTN, "0000459967");
                            EDIWrite.WriteOrder(conKTN, "0000460169");
                            break;
                        case "WriteProductList":
                            EDIWrite.WriteProductList(conLive, "100994002");
                            break;
                        case "PO":
                            EDIWrite.WriteASNFile(conDev, "0000023543");
